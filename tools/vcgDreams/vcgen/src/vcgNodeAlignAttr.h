...
#ifndef __vcgNodeAlignAttr
#define __vcgNodeAlignAttr


/** vcg NodeAlign values */
typedef enum 
{
	vcgNodeAlign_BOTTOM,
	vcgNodeAlign_TOP,
	vcgNodeAlign_CENTER,
	vcgNodeAlign_NUM_VALUES
} vcgNodeAlign;
...
class vcgNodeAlignAttr
{
	public:
		 ...
		 */ 
		static char* toStr(vcgNodeAlign value);

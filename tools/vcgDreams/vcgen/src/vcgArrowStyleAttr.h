...
#ifndef __vcgArrowStyleAttr
#define __vcgArrowStyleAttr


/** vcg ArrowStyle values */
typedef enum 
{
	vcgArrowStyle_NONE,
	vcgArrowStyle_LINE,
	vcgArrowStyle_SOLID,
	vcgArrowStyle_NUM_VALUES
} vcgArrowStyle;
...
class vcgArrowStyleAttr
{
	public:
		 ...
		 */ 
		static char* toStr(vcgArrowStyle value);

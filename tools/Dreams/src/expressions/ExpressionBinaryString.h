...
/**
  * @file  ExpressionBinaryString.h
  * @brief
  */

#ifndef _EXPRESSION_BINARY_STRING_H_
#define _EXPRESSION_BINARY_STRING_H_
 ...
 */
class ExpressionBinaryString : public Expression
{
  private:
  ...
  public:
     ...
     * Constructor
     */
    ExpressionBinaryString(DralDB * _draldb, ExpressionOperatorType _op, Expression *_left, Expression *_right);

    /**
     * Destructor
     */
    ~ExpressionBinaryString();
...
#endif // _EXPRESSION_BINARY_STRING_H_

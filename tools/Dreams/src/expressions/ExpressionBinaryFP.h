...
/**
  * @file  ExpressionBinaryFP.h
  * @brief
  */

#ifndef _EXPRESSION_BINARY_FP_H_
#define _EXPRESSION_BINARY_FP_H_
 ...
 */
class ExpressionBinaryFP : public Expression
{
  private:
  ...
  public:
     ...
     * Constructor
     */
    ExpressionBinaryFP(ExpressionOperatorType _op, Expression *_left, Expression *_right);
...
#endif // _EXPRESSION_BINARY_FP_H_

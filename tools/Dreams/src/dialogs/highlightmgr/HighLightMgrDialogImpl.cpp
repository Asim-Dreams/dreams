...
/**
  * @file HighLightMgrDialogImpl.cpp
  */
...
/* 
 *  Constructs a HighLightMgrDialogImpl which is a child of 'parent', with the 
 *  name 'name' and widget flags set to 'f' 
 *
 *  The dialog will by default be modeless, unless you set 'modal' to
 *  TRUE to construct a modal dialog.
 */
HighLightMgrDialogImpl::HighLightMgrDialogImpl( QWidget* parent,  const char* name, bool modal, WFlags fl )
    : HighLightMgrDialog( parent, name, modal, fl )
{
 ...
 */
HighLightMgrDialogImpl::~HighLightMgrDialogImpl()
{
    // no need to delete child widgets, Qt does it all for us
}

void 
HighLightMgrDialogImpl::accept_clicked()
{ done(1); }

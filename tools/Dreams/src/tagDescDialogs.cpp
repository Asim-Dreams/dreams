...
void
ShowTagDescDialog::insertItem(QString value, QString type, QString longDesc)
{
    tagList->insertItem(new QListViewItem(tagList, value, type, longDesc));
}

 ...
 * application must inherit from AMemObj. This is a simple mechanism
 * to be able to know (in detail) the amount of dynamically allocated
 * memory used at any moment.
 *
 * @version 0.1

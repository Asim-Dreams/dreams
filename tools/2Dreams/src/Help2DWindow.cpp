...
Help2DWindow::Help2DWindow( const QString& home_, const QStringList& _path,QWidget* parent, const char *name ) :
...
void
Help2DWindow::setBackwardAvailable( bool b)
{
    menuBar()->setItemEnabled( backwardId, b);
}

void
Help2DWindow::setForwardAvailable( bool b)
{
...
void
Help2DWindow::textChanged()
{
    //printf ("Help2DWindow::textChanged() called\n");fflush(stdout);
...
void
Help2DWindow::pathSelected( const QString &_path )
{
...
void
Help2DWindow::bookmChosen( int i )
{

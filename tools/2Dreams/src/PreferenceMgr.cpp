...
{
    if (_myInstance==NULL)
        _myInstance = new PreferenceMgr(companyName);Q_ASSERT(_myInstance!=NULL);
...
{
    if (_myInstance==NULL)
        _myInstance = new PreferenceMgr("BSSAD");Q_ASSERT(_myInstance!=NULL);
...
PreferenceMgr::PreferenceMgr(QString companyName)
{
    ...
    applicationPrefix = QString("/2Dreams/"); // By now hardcoded app name
...
{
    maxIFI = (UINT32)
    settings->readNumEntry(applicationPrefix+"Dbase/" + "maxIFI",LIVEDB_DEFAULT_MAXITEMCNT);
...
PreferenceMgr::loadDockedWindowsPreferences()
{
        ...
        eventWindowHeight =
        settings->readNumEntry(applicationPrefix+"DockedWindows/"+"eventWindowHeight",150);
        ...
        eventWindowWidth =
        settings->readNumEntry(applicationPrefix+"DockedWindows/"+"eventWindowWidth",256);
        ...
        eventWindowIdx =
        settings->readNumEntry(applicationPrefix+"DockedWindows/"+"eventWindowIdx",1);
        ...
        eventWindowOffset =
        settings->readNumEntry(applicationPrefix+"DockedWindows/"+"eventWindowOffset",0);
        ...
        eventWindowNl =
        settings->readBoolEntry(applicationPrefix+"DockedWindows/"+"eventWindowNl",false);
        ...
        showEventWindow =
        settings->readBoolEntry(applicationPrefix+"DockedWindows/"+"showEventWindow",true);
        ...
        QString EventWindowDockPolicyString =
        settings->readEntry(applicationPrefix+"DockedWindows/"+"eventWindowDockPolicy","DockRight");
        ...
        ok = ok && parseDock(EventWindowDockPolicyString,eventWindowDockPolicy);
...
#endif
        logFileName =
        settings->readEntry(applicationPrefix+"logFileName",basePath+"2DreamsLog.txt");
...
PreferenceMgr::saveDockedWindowsPreferences()
{
    ...
    settings->writeEntry(applicationPrefix+"DockedWindows/"+"eventWindowHeight",eventWindowHeight);
    ...
    settings->writeEntry(applicationPrefix+"DockedWindows/"+"eventWindowWidth",eventWindowWidth);
    ...
    settings->writeEntry(applicationPrefix+"DockedWindows/"+"eventWindowIdx",eventWindowIdx);
    ...
    settings->writeEntry(applicationPrefix+"DockedWindows/"+"eventWindowOffset",eventWindowOffset);
    ...
    settings->writeEntry(applicationPrefix+"DockedWindows/"+"eventWindowNl",eventWindowNl);
    ...
    settings->writeEntry(applicationPrefix+"DockedWindows/"+"showEventWindow",showEventWindow);
    ...
    settings->writeEntry(applicationPrefix+"DockedWindows/"+"eventWindowDockPolicy",dock2String(eventWindowDockPolicy));

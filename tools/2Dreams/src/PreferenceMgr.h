...
/**
  * A small helper object for 2Dreams preference management.
...
class PreferenceMgr : public QObject
{
    ...
    public:
        ...
        inline void setEventWindowWidth(int  value);
        ...
        inline void setEventWindowHeight(int  value);
        ...
        inline void setShowEventWindow(bool value);
        ...
        inline void setEventWindowDockPolicy(Dock value);
        ...
        inline void setEventWindowIdx   (int  value);
        ...
        inline void setEventWindowOffset (int  value);
        ...
        inline void setEventWindowNl (bool value);
...
bool
PreferenceMgr::getShowEventWindow()
...
enum Qt::Dock
PreferenceMgr::getEventWindowDockPolicy()
{ return eventWindowDockPolicy; }
...
int
PreferenceMgr::getEventWindowIdx()
{ return eventWindowIdx; }
...
int
PreferenceMgr::getEventWindowOffset()
{ return eventWindowOffset; }
...
bool
PreferenceMgr::getEventWindowNl()
{ return eventWindowNl; }
...
int
PreferenceMgr::getEventWindowWidth()
{ return eventWindowWidth; }
...
int
PreferenceMgr::getEventWindowHeight()
{ return eventWindowHeight; }
...
void
PreferenceMgr::setShowEventWindow(bool value)
...
void
PreferenceMgr::setEventWindowDockPolicy(Dock value)
{ eventWindowDockPolicy = value; }
...
void
PreferenceMgr::setEventWindowIdx   (int  value)
{ eventWindowIdx   = value; }
...
void
PreferenceMgr::setEventWindowOffset   (int  value)
{ eventWindowOffset   = value; }
...
void
PreferenceMgr::setEventWindowNl  (bool value)
{ eventWindowNl  = value; }
...
void 
PreferenceMgr::setEventWindowWidth(int  value)
{ eventWindowWidth=value; }
...
void 
PreferenceMgr::setEventWindowHeight(int  value)
{ eventWindowHeight=value; }
